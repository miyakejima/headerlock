...
// Verify cache buster version bumped to v=7.7.0
if (!html.includes("app.js?v=7.7.0") || !html.includes("styles.css?v=7.7.0")) {
  console.error("FAIL: Cache buster versions in index.html must be v=7.7.0");
  process.exit(1);
}
